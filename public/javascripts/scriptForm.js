...
(() =>{
  ...
  class s {
    ...
    _handleInputAction() {
      ...
      if (this.validations.forEach((e=>{
        ...
        i = e('input', n);
        if (t) {
          if (i.forEach((t=>t.dataset.sbCanSubmit = 'yes')), this.isPure) return this.onChange(),
          void (this.isPure = !1);
  ...
  const l = (r, o) =>{
    ...
    'API_TOKEN' === b && (d = !1, console.log("Free template utilisé : https://github.com/startbootstrap/startbootstrap-agency"));
  ...
  u = t=>{
    ...
    return t.forEach((t=>{
      if ('checkbox' === t.type || 'radio' === t.type) return e[t.name] || (e[t.name] = {
      }),
